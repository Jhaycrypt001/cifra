...
export const REGISTRY_ABI = [
  ...
  "function proveIncomeAbove(uint64 threshold)",
  "function incomeHandleOf(address account) view returns (bytes32)",
  "function invoicesPaidBy(address account) view returns (uint32)",
